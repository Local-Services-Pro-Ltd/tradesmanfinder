...
/* ─────────────────────────────────────────────
   PR-A1b: magic-link sign-in email.

   Same template handles sign-up and sign-in — only the copy differs. We
   intentionally do NOT include the email address in the URL: the URL is
   capability-bearing (whoever holds it gets in), so passing the email back
   on the query string would be both redundant and leakier.
   ───────────────────────────────────────────── */
